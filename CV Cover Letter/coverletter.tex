...
\position{Ingeniero de Software{\enskip\cdotp\enskip}Full stack}
\address{Meellin. Antioquia. Colombia}

\mobile{(+57) 3059427297}
\email{gluoneros@gmail.com}
\homepage{www.gluoneros.com}
\github{gluoneros}
\linkedin{hildebrando-vargas}
% \gitlab{gitlab-id}
...
\recipient
  ...
  {\textbf{Bancolombia}.\\ Medellin \\ Colombia}
% The date on the letter, default is the date of compilation
\letterdate{\today}
% The title of the letter
\lettertitle{Aplicación  para Ingeniero de Software }
% How the letter is opened
\letteropening{.}
% How the letter is closed
\letterclosing{Atentamente,}
% Any enclosures with the letter	
\letterenclosure[Attached]{Hoja de vida}
...
\lettersection{Cultura de trabajo}
...
\lettersection{Cómo puedo dar valor a su equipo?}
