...
\begin{document}
	...
	\begin{center}
		\begin{tabular}{ c c c }
			\faMobile\enspace +57 3059427297 & \enspace gluoneros@gmail.com & \faHome\enspace Medellin , Colombia \\
			\faLinkedin\enspace \color{blue} \href{https://www.linkedin.com/in/????/}{in/something} &
			\faGithub\enspace \color{blue} \href{https://github.com/gluoneros}{github.com/gluoneros} & \enspace {$\mathbb{X}$}\enspace \color{blue} \href{https://gluoneros.com}{https://gluoneros.com}
		\end{tabular}
	\end{center}
	
	\section{Profile}
	{Innovative  software engineering professional with a bachelor’s degree in mathematics and physics. As a versatile DevOps engineer and certified Linux administrator, I bring over six years of experience in system and network administration. My expertise spans scripting and automation using Python and Bash, as well as managing deployment processes to enable the continuous delivery of high-quality software solutions. Additionally, I am a passionate Full-Stack Developer with a flair for creating intuitive user interfaces and robust backend systems, ensuring impactful and efficient digital experiences.}
	
	\section{Areas of Expertise}
	{Backend python - WordPress - backend java -  - Data Analysis - Visualizing with Advanced Charts - Social Media - Email Marketing - User Experience - Digital Strategy - Campaign Management - Lead Generation}
